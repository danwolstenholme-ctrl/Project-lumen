...
export const clerkAppearance = {
  ...
  elements: {
    ...
    cardBox: "!bg-white rounded-2xl shadow-xl border border-zinc-100",
    headerTitle:
      "font-[family-name:var(--font-raleway)] tracking-wide !text-zinc-900",
    ...
    formFieldInput:
      "!bg-zinc-100 !border !border-zinc-200 !text-zinc-900 focus:!border-fuchsia-500 focus:!ring-1 focus:!ring-fuchsia-500 transition-colors placeholder:!text-zinc-400",
    formButtonPrimary:
      "!bg-gradient-to-r !from-fuchsia-500 !to-purple-500 hover:!opacity-90 !text-white font-semibold tracking-wide transition-opacity !shadow-none",
    footerActionLink:
      "!text-fuchsia-600 hover:!text-purple-600 transition-colors",
