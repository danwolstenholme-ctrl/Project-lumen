...
function categoryClass(cat: string | null) {
  return cat ? (categoryColors[cat.toLowerCase()] ?? "text-zinc-400 bg-zinc-400/10 border-zinc-400/20") : "text-zinc-400 bg-zinc-400/10 border-zinc-400/20";
}
    ...
    <div className="px-8 py-8 max-w-7xl mx-auto w-full">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-900 border border-zinc-800 text-sm font-manrope font-medium text-zinc-300 hover:border-fuchsia-500/40 hover:text-white transition-colors"
          >
      ...
      <div className="relative mb-8 max-w-sm">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2.5 rounded-lg bg-zinc-900 border border-zinc-800 text-sm font-manrope text-white placeholder:text-zinc-500 focus:outline-none focus:border-zinc-700 transition-colors"
        />
      </div>
      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-32 text-center gap-4">
          ...
          <div>
            <p className="font-raleway text-white font-semibold text-lg">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col gap-3 p-4 flex-1">
                  <div>
                    <h3 className="font-raleway font-semibold text-white text-sm leading-snug line-clamp-1">
                      {show.title}
                    </h3>
                    {show.users?.name && (
                  ...
                  {show.description && (
                    <p className="font-manrope text-xs text-zinc-400 leading-relaxed line-clamp-2 flex-1">
                      {show.description}
                    </p>
                  )}
